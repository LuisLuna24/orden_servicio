        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-10">
                ...
                <div class="flex justify-between mt-5">
                    <x-button-routing href="{{ route('clientes.dclientes') }}" wire:navigate.hover><svg
                        ...
                        </svg> Anterior</x-button-routing>
                    <x-button-routing href="{{ route('clientes.verorden') }}" wire:navigate.hover>Siguiente <svg
                            xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
