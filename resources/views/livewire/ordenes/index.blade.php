            ...
            <tbody>
                <tr
                    ...
                    <td class="px-6 py-4 text-right">
                        <x-button-routing href="{{ route('ordenes.show', '024000001') }}" wire:navigate.hover>
                            <svg
                ...
                <tr
                    ...
                    <td class="px-6 py-4 text-right">
                        <x-button-routing href="{{ route('ordenes.show', '024000002') }}" wire:navigate.hover>
                            <svg
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-eye">
                ...
                <tr
                    ...
                    <td class="px-6 py-4 text-right">
                        <x-button-routing href="{{ route('ordenes.show', '024000003') }}" wire:navigate.hover>
                            <svg
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-eye">
